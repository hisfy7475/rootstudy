...
// (명사=1, 동사=2, 형용사=3, 부사=4, 숙어=5). 한 단어가 여러 품사에 동시 소속될 수 있다.
// ⚠️ 번호↔품사는 클라이언트가 보내주는 원본 꾸러미 파일의 규약이다. 업로드된 전체 데이터로
//   검증한 결과 2=동사(97%), 3=형용사, 4=부사/전치사 로, 기존 상수(2=형용사/3=부사/4=동사)는
//   오표기였다. 학생 예습 화면·관리자 목록에 그대로 노출되므로 원본 규약에 맞춘다.
//
