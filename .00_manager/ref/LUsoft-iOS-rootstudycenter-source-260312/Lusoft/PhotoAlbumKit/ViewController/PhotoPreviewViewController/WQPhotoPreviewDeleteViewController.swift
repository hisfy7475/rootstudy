...
public class WQPhotoPreviewDeleteViewController: WQPhotoBaseViewController, UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    override func rightButtonClick(button: UIButton) {
            let deleteAlert = UIAlertController(title: nil, message: "이미지를 삭제하시겠읍니까？", preferredStyle: .alert)
            ...
            let deleteAction = UIAlertAction(title: "삭제", style: .default, handler: { [unowned self] (alertAction) in
