...
//  lusoft
//
//  Created by Atimu on 2023. 2. 6..
//  Copyright © 2023년 lusoft. All rights reserved.
//
...
class BACodeViewController: UIViewController, AVCaptureMetadataOutputObjectsDelegate {
    ...
    func metadataOutput(_ output: AVCaptureMetadataOutput, didOutput metadataObjects: [AVMetadataObject], from connection: AVCaptureConnection) {
        for metaData in metadataObjects {
            ...
            if let unwraped = transformed {
                let postData : [String : String] = ["result" : "success", "type" : "bacode", "message" : unwraped.stringValue!]
